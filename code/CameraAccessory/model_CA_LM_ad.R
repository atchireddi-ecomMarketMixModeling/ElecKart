...
model_data <- subset(model_data,select=-c(adTV,discount,adSEM,NPS,list_mrp))
# model_data <- subset(model_data,select=-c(adTV,discount,adSEM))
...
plot(model_data$gmv,main = 'CameraAccessory Linear Model with AdStock - Final',
